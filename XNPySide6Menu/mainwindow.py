...
class MainWindow(QMainWindow):
    ...
    def __new__(cls, *args, **kwargs) -> None:
        ...
        cls._QObject.add(instance)  # 存储自己
        return instance

    def __init__(self) -> None:
        super().__init__()
        self.setObjectName("DXNMainWindow")
        self.setStyleSheet(
            """QMainWindow#DXNMainWindow
            {
    ...
    def addMuen(
        ...
        参数:
            ...
            first_menu_img (str): 一级菜单图标\n
            first_menu_img_press (str): 一级菜单图标按下\n
            second_menu (List[str]): 二级菜单名称
        """
        menu = MenuLeftSideFirst(first_menu, first_menu_img, first_menu_img_press)
        MenuLeftSideSecondaryList(self.left_menu, menu, second_menu, self.display)
    ...
    @classmethod
    def addWidgetInstance(cls, widget: QWidget, name: str) -> None:
        """添加右侧窗口控件
    ...
    def _showNormal(self, pos: QPoint) -> None:
        ...
        """
        self.showNormal()
        self.move(pos.x() - MainWindow._w // 2, pos.y() - MyTip._h // 2)
    ...
    @staticmethod
    def add_popup(
        text: str, title: Optional[str] = "", flag: Optional[str] = "success"
    ) -> None:
        """弹窗控件
        ...
        参数:
            ...
            flag (Optional[str], optional): 弹窗类型."warning" or "danger" or "success" Defaults to "success".
        """
        DialogOver(list(MainWindow._QObject)[0], text, title, flag)
